...
// images
import Intervyou1 from "@/public/parv/Home.png";
import Intervyou2 from "@/public/parv/DesignPage.png";
import Intervyou3 from "@/public/parv/Home_Footer.png";
import ProjectAll from "@/public/Thumbnail.png";
				...
				<div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
					...
					<motion.div
						...
						<p className="text-gray-600 text-justify title text-lg">
							PARVENETTA lets you create your suit right in front of you — from jacket to pant — by selecting fabric, lapels, buttons, pockets, stitching, and more in an intuitive live configurator. The second module, Build Your Brand, enables end-to-end customization of apparel like T‑shirts, hoodies, and zip hoodies — including pockets, trims, panel placements, and top‑stitching — through a comprehensive nine‑step process.
						</p>{" "}
						<div className="mt-3">
							<Button variation="primary">
								<Link href="projects/parvenetta">More</Link>
							</Button>
							<Button variation="secondary">
								<a
									href="https://parvenetta.com/"
									target="_blank"
