						...
						<div className="section">
							<div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
								<motion.div
									...
									<motion.h1
										className="text-black text-5xl md:text-6xl lg:text-7xl 2xl:text-7xl font-bold my-2 md:my-5"
										initial={{ x: -100, opacity: 0 }}
										whileInView={{ x: 0, opacity: 1 }}
										transition={{
											delay: 0.3,
									...
									<motion.p
										...
										Hi! I&rsquo;am Mansoor, A Web Developer and Data Analyst specializing in Next.js, React.js, Power BI, Tableau, Excel VBA automation,
										and robust ETL processes, with a growing secondary focus on Data Engineering.
										I am passionate about building scalable web applications and leveraging AI and data analytics to deliver insights and innovation.
									</motion.p>
									<motion.div
							...
							<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
								...
								<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
									...
									<div className="flex justify-center items-center space-x-4">
										<motion.a
											href="mailto:mansoorky333@gmail.com"
										...
										<motion.a
											href="https://github.com/mansoor369"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
