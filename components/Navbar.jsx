			...
			<motion.div
				...
				<div className="relative backdrop-blur-sm opacity-95 flex flex-col items-center space-x-8 min-h-[100vh] bg-gray-700 min-w-[100vw] ">
					<div className="flex flex-col items-center space-y-8 my-auto mx-0 z-50">
						...
						<Link href="/#home">
							<div
								className="text-2xl font-bold hover:bg-gray-900 p-2 rounded-2xl transition-all ease-in-out duration-150 text-white"
	...
	return (
		<>
			<nav
				...
				<div>
					<h1
						className={`text-3xl ml-2 md:ml-0 transition-colors ease duration-500 ${
				...
				<div className="flex flex-row items-center">
					<button
						className="burger button cursor-pointer flex flex-col justify-center items-center space-y-1.5 "
						onClick={toggleNav}>
						<div
