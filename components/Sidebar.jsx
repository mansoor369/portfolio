			...
			<ul
				...
				<li data-menuanchor="home" className="active">
					<button onClick={() => handleMoveToSection(1)}>
						<FontAwesomeIcon icon={faHome} className="text-xl cursor-pointer hover:bg-white hover:text-gray-700 p-2 rounded-2xl duration-100 ease-in-out transition-all" />
					</button>
				</li>
				<li data-menuanchor="about">
					<button onClick={() => handleMoveToSection(2)}>
						<FontAwesomeIcon icon={faUser} className="text-xl cursor-pointer hover:bg-white hover:text-gray-700 p-2 rounded-2xl duration-100 ease-in-out transition-all" />
					</button>
				</li>
				<li data-menuanchor="projects">
					<button onClick={() => handleMoveToSection(3)}>
						<FontAwesomeIcon
							icon={faFolderOpen}
							className="text-xl  hover:bg-white cursor-pointer hover:text-gray-700 p-2 rounded-2xl duration-100 ease-in-out transition-all"
						/>
					</button>
				</li>
